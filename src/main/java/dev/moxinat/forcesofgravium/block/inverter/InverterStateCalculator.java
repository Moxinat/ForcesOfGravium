...
public final class InverterStateCalculator {
    ...
    public static void handleControlChange(
        ...
        Nodes.Node controlSource =
                Nodes.get(world, controlSourcePosition);
        ...
        Nodes.Node inverter =
                Nodes.get(world, inverterPosition);

        if (inverter == null
                || !inverter.invertCapable()) {
            return;
        }

        inverter = inverter.withInvertEnabled(
