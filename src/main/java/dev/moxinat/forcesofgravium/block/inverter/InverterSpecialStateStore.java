...
public final class InverterSpecialStateStore {

    // Owns inverter-only edge/toggle state such as nextMode and lastToggleInputMode.
    // Shared timeline and invertEnabled fields here are compatibility mirrors; ConnectableRuntimeData is authoritative.
    private static final Map<BlockKey, InverterData> DATA = new ConcurrentHashMap<>();

    private InverterSpecialStateStore() {
    }
    ...
    public record InverterData(
        ...
        public InverterData {
            ...
            lastToggleInputMode = GravityPowderSpecialStateStore.normalizeState(lastToggleInputMode);
        ...
        public static @Nonnull InverterData defaultData() {
            return initialize("off", "off", true, GravityPowderSpecialStateStore.STATE_OFF);
        }
        ...
        public boolean toggleInputActive() {
            return !GravityPowderSpecialStateStore.STATE_OFF.equals(lastToggleInputMode);
        }
    ...
    private static @Nonnull String modeFromLegacyToggle(boolean toggleInputActive) {
        return toggleInputActive ? GravityPowderSpecialStateStore.STATE_PUSH : GravityPowderSpecialStateStore.STATE_OFF;
    }
